...
<div class="panel-body">   
    ...
    <form action="{{route('insert-al-amin-invoice')}}" id="invoice-form" method="post" class="invoice-form" role="form" novalidate=""> 
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-left">
                   <div class="form-group">
                        <textarea class="form-control @error('transport') is-invalid @enderror" rows="2" name="transport" id="transport"value="{{ old('transport') }}" placeholder="transport cost" required></textarea>
                        @error('transport')
