...
<html>
<head>
	<title>Meridian Proforma Invoice</title>
...
<table  width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top:-125px;">
	...
	<td colspan="2" style="padding-left:10px; ">
		...
		<div style="color: #60332D;">
			   ...
			   <!-- <img style=" height:80px; width: 80px; float:left;" src="../images/meridian2.png" />
			<b style="background-color:#E99067; font-size: 18px; font-family:Eurostile,sans-serif; ">Company Name </b><br/>
			<b style="font-size: 16px; font-family:Eurostile,sans-serif; ">MERIDIAN CHEF'S & CATERING SUPPLY</b><br/>
			<b style="font-size: 11px; font-family:Eurostile,sans-serif; color:#915C91; ">We deal with:- all kind of dry food, coocked food, bites and refreshment.
(ENJOY YOUR EVENT)</b><br/>
    <hr><br>
            <div style="margin-top:-20">
			<b>Email:info@meridian.com</b><br>
	...
	<td width="25%">
		...
		<p width="60%"  style="color:#60332D; font-size:12px; font-family:Eurostile, sans-serif;"><b><u>PROFORMA INVOICE</u></b></p>
		<div >
		...
		<tr>
			...
			<td>
				<span style="color:#60332D">{{ date('d-m-Y', strtotime($invoice->created_at)) }}</span>
			</td>
		</tr>
	...
	<div style="border:outset 4px #E99067; color:#60332D; font-family:Eurostile,sans-serif; font-size: 12px;">
