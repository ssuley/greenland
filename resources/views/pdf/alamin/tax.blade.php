...
<table  width="100%" border="0" cellpadding="5" cellspacing="0"style="margin-top:-50px;">
	...
	<td colspan="2" style="padding-left:10px;">
		...
		<div style="color: #FFD700;  ">
			<br/><br/>
			<b style="font-size: 25px; font-family:Eurostile,sans-serif; ">AL-AMIN SHOP</b><br/>
	...
	<b style="color:#323639; font-size:12px; font-family:Eurostile,sans-serif;">Date : {{ date('d-m-Y') }}</b><br />
	</td>
    ...
    <hr style=" border: 2px solid #323639;"> </hr>
	  <p colspan="2" width="60%" align="center" style="color:#293642; font-size:16px;  font-family:Copperplate, sans-serif;"><b><u>TAX INVOICE</u></b></p>
	...
	<td align="left"><center>{{  number_format(($invoice_item->invoice_item_final_amount)+$Tvat, 2 , '.' , ',') }}</center></td>
		  
	</tr>
	<?php $total+=($invoice_item->invoice_item_final_amount)+$Tvat; ?>
	@endforeach
	<tr style="background-color:#FFD700;">
	<td align="right" colspan="6">TOTAL(VAT INCL)</td>
