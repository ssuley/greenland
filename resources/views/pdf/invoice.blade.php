...
<table  width="100%" border="0" cellpadding="5" cellspacing="0"style="margin-top:-50px;">
	...
	<b style="color:#008000; font-size: 12px; Eurostile ,sans-serif;">Invoice Date : {{ date('d-m-Y', strtotime($invoice->created_at)) }}</b><br />
	</td>
	</tr>
	</table>
	  <p colspan="2" width="60%" style="font-size:23px; font-family:Eurostile,sans-serif;"  align="center" ><b><u>PROFORMA INVOICE</u></b></p>
