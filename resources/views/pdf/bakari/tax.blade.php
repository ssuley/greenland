...
<html>
<head>
	<title>Bakari Tax Invoice</title>
...
<table  width="100%" border="0" cellpadding="4" cellspacing="0" style="margin-top: -65px;">
	...
	<td colspan="4">
		...
		<p   style=" font-size:12px; font-family:Eurostile, sans-serif;"><center><b><u>TAX INVOICE</u></b></center></p>
		...
		<div style="float: right;">
				...
				<span style="font-size:10px; font-family:Eurostile,sans-serif;">{{ date('d-m-Y') }}</span>
